...
export const localizedContent = {
  ko: makeContent("ko", {
    documentTitle: "Haein Oh - Make It Fun",
    profile: {
      name: "Haein Oh",
      realName: "Haein Oh",
    ...
    ui: {
      ...
      projects: { eyebrow: "Projects", title: "프로젝트", open: "프로젝트 보기", github: "GitHub에서 보기" },
      activities: { eyebrow: "Activities & Press", title: "대외활동 · 뉴스", desc: "인터뷰, 프로그램 참여, 외부 보도까지. 게임을 만들고 밖으로 꺼내며 쌓은 기록들입니다." },
      testimonials: { eyebrow: "Professional Reference", title: "추천서", desc: "Halfbrick에서 함께 일한 리더가 남긴 레퍼런스입니다.", label: "Professional reference", linkedin: "LinkedIn에서 보기" },
  ...
  en: makeContent("en", {
    ...
    ui: {
      ...
      hero: { bullets: ["Player-first", "Fast prototyping", "Juicy game feel"], primary: "Experience & Projects", loading3d: "Loading 3D model…", scrollDown: "Scroll down" },
      ...
      projects: { eyebrow: "Projects", title: "Projects", open: "View Project", github: "View on GitHub" },
      ...
      testimonials: { eyebrow: "Professional Reference", title: "Reference", desc: "A reference from a leader I worked with at Halfbrick.", label: "Professional reference", linkedin: "View on LinkedIn" },
  ...
  zh: makeContent("zh", {
    ...
    ui: {
      ...
      hero: { bullets: ["玩家优先", "快速原型制作", "爽快手感"], primary: "经历与项目", loading3d: "正在加载 3D 模型…", scrollDown: "向下滚动" },
      ...
      projects: { eyebrow: "Projects", title: "项目", open: "查看项目", github: "在 GitHub 查看" },
      activities: { eyebrow: "Activities & Press", title: "活动 · 新闻", desc: "采访、项目参与和媒体报道，记录我把游戏做出来并带到外部的过程。" },
      testimonials: { eyebrow: "Professional Reference", title: "推荐信", desc: "来自 Halfbrick 共事领导的职业推荐。", label: "Professional reference", linkedin: "在 LinkedIn 查看" },
  ...
  ja: makeContent("ja", {
    ...
    ui: {
      ...
      hero: { bullets: ["プレイヤーファースト", "高速プロトタイピング", "気持ちいい手触り"], primary: "経験とプロジェクト", loading3d: "3Dモデルを読み込み中…", scrollDown: "下へスクロール" },
      ...
      projects: { eyebrow: "Projects", title: "プロジェクト", open: "プロジェクトを見る", github: "GitHubで見る" },
      activities: { eyebrow: "Activities & Press", title: "活動・ニュース", desc: "インタビュー、プログラム参加、外部メディア掲載など、ゲームを作り外へ届けた記録です。" },
      testimonials: { eyebrow: "Professional Reference", title: "推薦文", desc: "Halfbrickで一緒に働いたリーダーからのレファレンスです。", label: "Professional reference", linkedin: "LinkedInで見る" },
